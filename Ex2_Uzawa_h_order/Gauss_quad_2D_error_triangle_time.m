function r=Gauss_quad_2D_error_triangle_time(uh_local,uh_local_exact,vertices,basis_index,Gauss_coefficient_reference_triangle,Gauss_point_reference_triangle,basis_type,derivative_degree_x,derivative_degree_y,a)
...
for i=1:Gpn    % exact solution - numerical solution
    r=r+Gauss_coefficient_local_triangle(i)*(FE_solution_triangle_index(Gauss_point_local_triangle(i,1),Gauss_point_local_triangle(i,2),uh_local_exact,vertices,basis_index,basis_type,derivative_degree_x,derivative_degree_y)-a*FE_solution_triangle_index(Gauss_point_local_triangle(i,1),Gauss_point_local_triangle(i,2),uh_local,vertices,basis_index,basis_type,derivative_degree_x,derivative_degree_y))^2;
end