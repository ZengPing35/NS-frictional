...
figure_u = 1/640;
figure_p = 1/640;
time_interval_p = 1/160;
time_interval_u = 1/160;
time_figure_err = 0.25;
%% remenber to revise the 'figure_u' and 'figure_p' parts in 'Navier_Stokes_solver' file.
...
filename = strcat('uh1_exact_',num2str(1/tau),'.mat');
save(filename, 'uh1_exact');
filename = strcat('uh2_exact_',num2str(1/tau),'.mat');
save(filename, 'uh2_exact');
filename = strcat('ph_exact_',num2str(1/tau),'.mat');
save(filename, 'ph_exact');


%% Numerical solution (tau=1/10)
tau=1/10
...
filename = strcat('uh1_',num2str(1/tau),'.mat');
save(filename, 'uh1');
filename = strcat('uh2_',num2str(1/tau),'.mat');
save(filename, 'uh2');
filename = strcat('ph_',num2str(1/tau),'.mat');
save(filename, 'ph');
...
uh_L2_error_1=sqrt(uh1_L2_error^2+uh2_L2_error^2)
ph_L2_error_1=sqrt(ph_L2_error^2)
...
uh_H1_error_1=sqrt(uh1_H1_error^2+uh2_H1_error^2)
uh_H1_1 = sqrt(uh_L2_error_1^2+uh_H1_error_1^2)
...
colormap(jet);
xlabel('x'),ylabel('y');
picturename = strcat('u_p_t_end_1.fig');
saveas(gca,picturename,'fig');
close;


%% Numerical solution (tau=1/20)
tau=1/20
[uh1,uh2,ph] = Navier_Stokes_solver(left,right,bottom,top,t_start,t_end,tau,h_partition,Gauss_point_number,basis_type_u,basis_type_p,max_iteration_step,tolerence,time_figure_err,figure_p,time_interval_p,figure_u,time_interval_u);
...
uh2_L2_error=FE_solution_error_triangle_index(uh2,uh2_exact,left,right,bottom,top,h_partition,u_basis_index,basis_type_u,0,0,Gauss_point_number,N2_partition_fine);
ph_L2_error=FE_solution_error_triangle_index(ph,ph_exact,left,right,bottom,top,h_partition,p_basis_index,basis_type_p,0,0,Gauss_point_number,N2_partition_fine);
uh_L2_error_2=sqrt(uh1_L2_error^2+uh2_L2_error^2)
r=(log(uh_L2_error_1)-log(uh_L2_error_2))/(log(2));
fprintf('Convergence order of uh_L2 = %f***\n',r);
ph_L2_error_2=sqrt(ph_L2_error^2)
r=(log(ph_L2_error_1)-log(ph_L2_error_2))/(log(2));
...
uh2_H1_error_y=FE_solution_error_triangle_index(uh2,uh2_exact,left,right,bottom,top,h_partition,u_basis_index,basis_type_u,0,1,Gauss_point_number,N2_partition_fine);
uh2_H1_error=sqrt(uh2_H1_error_x^2+uh2_H1_error_y^2);
uh_H1_error_2=sqrt(uh1_H1_error^2+uh2_H1_error^2)
r=(log(uh_H1_error_1)-log(uh_H1_error_2))/(log(2));
fprintf('Convergence order of uh_sime_H1 = %f***\n',r)
uh_H1_2 = sqrt(uh_L2_error_2^2+uh_H1_error_2^2)
r=(log(uh_H1_1)-log(uh_H1_2))/(log(2));
...
colormap(jet);
xlabel('x'),ylabel('y');
picturename = strcat('u_p_t_end_2.fig');
saveas(gca,picturename,'fig');
close;


%% Numerical solution (tau=1/40)
tau=1/40
[uh1,uh2,ph] = Navier_Stokes_solver(left,right,bottom,top,t_start,t_end,tau,h_partition,Gauss_point_number,basis_type_u,basis_type_p,max_iteration_step,tolerence,time_figure_err,figure_p,time_interval_p,figure_u,time_interval_u);
...
r=(log(uh_L2_error_2)-log(uh_L2_error_4))/(log(2));
fprintf('Convergence order of uh_L2 = %f***\n',r);
ph_L2_error_4=sqrt(ph_L2_error^2)
r=(log(ph_L2_error_2)-log(ph_L2_error_4))/(log(2));
fprintf('Convergence order of ph_L2 = %f***\n',r);
...
r=(log(uh_H1_error_2)-log(uh_H1_error_4))/(log(2));
fprintf('Convergence order of uh_sime_H1 = %f***\n',r)
uh_H1_4 = sqrt(uh_L2_error_4^2+uh_H1_error_4^2)
r=(log(uh_H1_2)-log(uh_H1_4))/(log(2));
fprintf('Convergence order of uh_H1 = %f***\n',r)
